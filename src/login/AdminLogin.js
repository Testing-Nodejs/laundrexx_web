    ...
    if (email === "" || email === null) {
      ...
      axios.post(MyApiUrl + "AdminLogin/", obj).then((response) => {
        if (response.data === false) {
          ...
          sessionStorage.setItem("UserID", response.data[0].SUPER_ADMIN_PKID);
          sessionStorage.setItem("UserTypeID", "All");
          sessionStorage.setItem("SessionType", "Admin");
          sessionStorage.setItem("UserPassword", response.data[0].SUPER_ADMIN_PASS);
