...
const ViewPreviousAuditReport = (props) => {
    ...
    const ToExcel = () => {
        ...
        const fileName = "PreviousAuditReport.csv";
    ...
    return (
        <div id="city">
            ...
            {ResponseData.length > 0 ?
                <h1 id="ccmaster">{ResponseData[0].STORE_NAME} Current Day Audit Report</h1>
                :
                <h1 id="ccmaster">Current Day Audit Report</h1>
            }
...
export default ViewPreviousAuditReport;
