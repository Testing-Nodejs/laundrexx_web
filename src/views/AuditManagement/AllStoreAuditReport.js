...
const AllStoreAuditReport = () => {
    ...
    const getAllOrders = () => {
        ...
        axios.get(MyApiUrl + "GetPreviousAuditReport/" + SessionType + "/" + UserID + "").then((response) => {
    ...
    return (
        <div id="city">
            ...
            <h1 id="ccmaster">All Outlet Audit Report</h1>
                                        ...
                                        "Action": (i) => (
                                            <td>
                                                <CButton
                                                    ...
                                                    style={{ fontSize: "12px" }}
                                                    onClick={() =>
                                                        history.push("/ViewAllStoreAuditReport", {
                                                            data: i,
                                                        })
                                                    }
                                                >
...
export default AllStoreAuditReport;
