...
const DeliveredOrders = () => {
    ...
    const getAllOrders = () => {
        ...
        axios.get(MyApiUrl + "GetAllDeliveredOrders/" + StoreID + "").then((response) => {
    ...
    const filterData = (customer, month, year) => {
        ...
        console.log(object);
        document.getElementById("divLoading").className = "show";
        axios.post(MyApiUrl + "GetAllDeliveredOrdersWithFilter", object).then((response) => {
            if (response.data.length > 0) {
                const items = response.data.map((item, index) => {
                    return {
                        ...item,
    ...
    return (
        <div id="city">
            ...
            <h1 id="ccmaster">View Delivered Orders</h1>
            ...
            <CRow>
                <CCol col="12">
                    <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        <CCardHeader>
                            <CRow>
                                <CCol col="6">View All Delivered Orders</CCol>
                            </CRow>
                        </CCardHeader>
                        <CCardBody>
                            <CDataTable
