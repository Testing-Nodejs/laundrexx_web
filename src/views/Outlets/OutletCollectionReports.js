...
const OutletCollectionReports = () => {
    ...
    const ToExcel = () => {
        ...
        csvData.push(
            '"Sl No","Collection Date","Collection Amount","Order Amount","Final Amount","Payment Mode","Balance Amount","Due Date","Order Date","Order Number","Bad Debit","Credit","Customer Name","Contact Number"'
        );
        ExcelData.map((item) => {
            ...
            return (
                ...
                csvData.push(
                    ...
                    cnt +
                    '","' +
                    SplitDate1(item.ORDER_PAYMENT_DATE) +
                    '","' +
                    item.ORDER_PAYMENT_COLLECTED_AMOUNT +
                    '","' +
                    item.ORDER_GRAND_TOTAL_AMOUNT +
                    '","' +
                    item.ORDER_PAYMENT_FINAL_AMOUNT +
                    '","' +
                    item.ORDER_PAYMENT_MODE +
                    '","' +
                    item.ORDER_PAYMENT_BALANCE_AMOUNT +
                    '","' +
                    ...
                    '","' +
                    item.ORDER_PAYMENT_BAD_DEBITS +
                    '","' +
                    item.ORDER_PAYMENT_CREDIT +
                    '","' +
                    item.CUSTOMER_NAME +
                    '","' +
        ...
        const fileName = "OutletCollectionReport.csv";
    ...
    return (
        <div id="city">
                                ...
                                {ResponseData.map((item, index) => {
                                    ...
                                    return (
                                        <tr>
                                            ...
                                            <td style={{ textAlign: "center" }}>{item.ORDER_PAYMENT_MODE}</td>
            ...
            <h1 id="ccmaster" style={{ marginTop: "3%" }}>Collection Report</h1>
...
export default OutletCollectionReports;
