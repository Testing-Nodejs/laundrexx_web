...
const OutletVerifyOtp = (props) => {
    ...
    const otpverification = localStorage.getItem("DeliveryOTP");
    ...
    const VerifyOtp = () => {
        ...
        axios.post(MyApiUrl + "VerifyDeliveryOTP", obj).then((response) => {
            ...
            {otpverification === "0" ? <CRow style={{ marginTop: "3%", alignContent: "center" }}>
                ...
                <CCol md="12" lg="6">
                    <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        <CCardHeader>Enter OTP</CCardHeader>
                        <CCardBody>
                            <CFormGroup row>
                                <CCol xs="12" md="12">
                                    <CLabel>OTP<span style={{ color: "red" }}> *</span></CLabel>
                                    <CInput
                                        id="NumOrder"
                                        name="NumOrder"
...
export default OutletVerifyOtp;