...
const ViewOutletSelfAudit = (props) => {
    ...
    const [ResponseData, setResponseData] = useState(OrderList);
    ...
    const ToExcel = () => {
        ...
        csvData.push(
            '"Sl No","Status","Order Number","Order Date","Invoice Number","Customer Name","Customer Contact Number","Door Delivery","Order Amount","Audit Date","Audit Time"'
        );
        ResponseData.map((item) => {
            ...
            return (
                ...
                csvData.push(
                    ...
                    '","' +
                    SplitDate(STORE_SELF_AUDIT_DATE) +
                    '","' +
                    STORE_SELF_AUDIT_TIME +
                    '","' +
                    '"'
        ...
        const fileName = "OutletSelfAuditReport.csv";
                            ...
                            <thead>
                                <tr>
                                    <td colspan="18" style={{
                                        ...
                                        Order Details &nbsp;&nbsp;Outlet Name: {StoreName} &nbsp;&nbsp;Staff Name: {UserName}
                                ...
                                {ResponseData.map((item, index) => {
                                    return (
                                        <tr>
                                            ...
                                            <td style={{ textAlign: "center" }}>{SplitDate(STORE_SELF_AUDIT_DATE)}</td>
                                            <td style={{ textAlign: "center" }}>{STORE_SELF_AUDIT_TIME}</td>
                                            <td style={{ textAlign: "center" }}>{item.STORE_SELF_AUDIT_ORDERS_STATUS === "false" || item.STORE_SELF_AUDIT_ORDERS_STATUS === false || item.STORE_SELF_AUDIT_ORDERS_STATUS === "0" || item.STORE_INVENTORY_STATUS === 0 ? "Not In Inventory" : item.STORE_SELF_AUDIT_ORDERS_STATUS === "true" || item.STORE_SELF_AUDIT_ORDERS_STATUS === true || item.STORE_SELF_AUDIT_ORDERS_STATUS === "1" || item.STORE_INVENTORY_STATUS === 1 ? "In Inventory" : "-"}</td>
                                        </tr>
                                    )
                                }
                                )}
                            ...
                            <CCardBody>
                                <CRow>
                                    <CCol md="2">
                                        ...
                                        <CInput
                                            type="text"
                                            value={SplitDate(STORE_SELF_AUDIT_DATE)}
                                            readOnly
                                        />
                                    </CCol>
                                    <CCol md="2">
                                            ...
                                            ResponseData.map((item, index) => {
                                                return (
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {item.STORE_SELF_AUDIT_ORDERS_STATUS == true || item.STORE_SELF_AUDIT_ORDERS_STATUS == "true" ?
...
export default ViewOutletSelfAudit;
