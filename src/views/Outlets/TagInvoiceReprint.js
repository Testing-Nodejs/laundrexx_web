...
const Reprinting = () => {
    ...
    const getAllOrders = () => {
        ...
        axios.get(MyApiUrl + "OutletOrders/" + StoreID + "").then((response) => {
    ...
    const printInvoice = async (OrderNo) => {
        ...
        if (OrderNo == null || OrderNo == "") {
            Toast.fire({
                icon: "warning",
                title: "Please Enter or Scan the Order QR Code!",
            });
            ...
            await axios.post(MyApiUrl + "OrderDetailsByNumber", obj).then(async (response) => {
                if (response.data.length > 0) {
                    setPrintOrderNo(response.data[0].ORDER_ORDER_NUMBER);
                    setblock4(false);
                    setModalPrint(true);
                }
            }).catch((error) => {
    ...
    return (
        <div id="city">
            ...
            <h1 id="ccmaster">Invoice and Tag Reprinting</h1>
            {modalPrint == true ?
                <div>
                ...
                <CCol col="12">
                    <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        <CCardBody>
                            <CRow>
                                <CCol md="2">
                                    <CLabel htmlFor="nf-email">Customer GST Type</CLabel>
                                    <CSelect
                                        custom
                                        name="merchant"
                                        value={Outlet}
            ...
            <CRow>
                <CCol col="12">
                    <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        <CCardHeader>
                            <CRow>
                                <CCol col="6" style={{ alignSelf: "center" }}>All Orders</CCol>
                                <CCol col="6">
                                    <CButton
                                        onClick={() => {
                                            setModalOrderID("");
                                    ...
                                    "Invoice": (i) => (
                                        <td>
                                            <CButton
                                                ...
                                                style={{ fontSize: "12px" }}
                                                onClick={() => {
                                                    printInvoice(i.ORDER_ORDER_NUMBER);
                                                }}
                                            >
                                                Print Invoice
                                            </CButton>
            ...
            <CModal show={block4} onClose={() => setblock4(!block4)} color="dark" style={{ height: 250 }}>
                <CModalHeader closeButton>
                    <CModalTitle>Print Invoice</CModalTitle>
                </CModalHeader>
                <CModalBody>
                    <CFormGroup row>
                        <CCol xs="12" md="12">
                            ...
                            <CInput
                                ...
                                onChange={(event) => {
                                    ...
                                    printInvoice(event.target.value);
                                }}
                            />
                        </CCol>
                    </CFormGroup>
