...
const EditAllOrders = () => {
    ...
    const DeleteOrder = (id) => {
        ...
        if (res) {
            document.getElementById("divLoading").className = "show";
            axios({ method: "DELETE", url: MyApiUrl + "DeleteOrder/" + id + "/" + UserType + "/" + UserID + "", headers: { "content-type": "application/json", }, })
                .then((response) => {
                    if (response.data == true) {
                        Swal.fire({
                            title: "Selected Order Deleted!",
                            icon: "success",
    ...
    return (
        <div id="city">
            ...
            <h1 id="ccmaster">Modify Orders</h1>
            {print == true ?
                <div>
            ...
            <CRow>
                <CCol col="12">
                    <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        <CCardHeader>
                            <CRow>
                                <CCol col="6" style={{ alignSelf: "center" }}>View All Orders</CCol>
                                <CCol col="6">
                                    <CButton
                                        onClick={() => {
                                            setModalOrderID("");
                ...
                <CModalBody>
                    <CFormGroup row>
                        <CCol xs="12" md="12">
                            ...
                            <CInput
                                id="ModalOrderID"
                                placeholder="Enter Order No./ Scan OR Code"
                                value={ModalOrderID}
                                onChange={(event) => {
