...
const EditCustomer = () => {
    ...
    const ToExcel = () => {
        ...
        csvData.push(
            '"Sl No","Customer Name","Outlet","Outlet Code","Coupon Name","Coupon Code","Coupon Discount","Coupon Availed","Address","Contact No.","Alt-Contact No.","Email","GST Type","GST No.","Customer Type","Reference","Added Date","isActive"'
        );
        ExcelData.map((item) => {
    ...
    const changeIsActive = async (id, val) => {
        await axios.get(MyApiUrl + "Activate_DeactivateCustomer/" + id + "/" + val + "").then((response) => {
        ...
        if (res) {
            axios({
                ...
                .then((response) => {
                    if (response.data === true) {
                        Swal.fire({
                            title: "Selected Customer Deleted!",
                            icon: "success",
                            confirmButtonText: "OK",
                        });
                        document.getElementById("divLoading").className = "hide";
    ...
    return (
        <div id="city">
            ...
            <h1 id="ccmaster">Manage Customers</h1>
            ...
            <CRow>
                <CCol col="12">
                    <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        <CCardHeader>
                            <CRow>
                                <CCol col="6">Manage Customers</CCol>
                                <CCol col="6">
                                    <CButton
                                        onClick={ToExcel}
                                        color="info"
                        ...
                        <CCardBody>
                            <CDataTable
                                ...
                                scopedSlots={{
                                    Action: (i) => (
                                        <td>
                                            <CButton
                                                size="sm"
                                                onClick={() =>
                                                    history.push("/EditCustomerDetails", {
                                                        data: i,
                                                    })
                                                }
                                                id="war-btn"
                                            ...
                                            <CButton
                                                size="sm"
                                                onClick={() => {
                                                    DeleteCustomer(i.CUSTOMER_PKID);
                                                }}
                                                id="war-btn1"
                                            >
                                                <DeleteSharpIcon />
                                    ...
                                    "Active/Deactive": (i) => (
                                        <td>
                                            {i.CUSTOMER_ACTIVE == 1 || i.CUSTOMER_ACTIVE == "1" ?
                                                <CButton
                                                    className="btn btn-warning"
                                                    style={{ fontSize: "12px" }}
                                                    onClick={() => {
                                                        changeIsActive(i.CUSTOMER_PKID, 0);
                                                    }}
                                                >
                                                    Deactivate
                                                </CButton>
                                                ...
                                                <CButton
                                                    ...
                                                    style={{ fontSize: "12px" }}
                                                    onClick={() => {
                                                        changeIsActive(i.CUSTOMER_PKID, 1);
                                                    }}
                                                >
                                                    Activate
                                                </CButton>
