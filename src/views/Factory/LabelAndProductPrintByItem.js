...
const LabelAndProductPrintByItem = () => {
        ...
        <div className="123">
            ...
            <CRow style={{ marginTop: "3%" }}>
                <CCol md="12">
                    ...
                    <h1 id="ccmaster" style={{ textAlign: "center" }}>Print Label & Product Stickers By Item Number / QR Code</h1>
                </CCol>
            </CRow>
            <CRow style={{ marginTop: "3%" }}>
                <CCol md="3"></CCol>
                <CCol md="6">
                    <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        <CCardHeader>Label & Product Stickers</CCardHeader>
                        <CCardBody>
                            <CFormGroup>
                                ...
                                <CInput
                                    ...
                                    onChange={(event) => {
                                        ...
                                        axios.post(MyApiUrl + "OrderDetailsByItemNumberPrint", obj).then((response) => {
                                            ...
                                            return (
                                                <table style={{ height: "80px", width: "100%", borderBottom: "3px solid rgb(0, 0, 0)", borderTop: "3px solid black" }} cellpadding="4" cellspacing="2" class="tbl">
                                                    <tr>
                                                        ...
                                                        <td style={{ border: "0px" }}>
                                                            <b>SD - {ItemInner.ORDER_ITEM_NUMBER.split("-")[3]}</b>
                                                        </td>
                                                    </tr>
...
export default LabelAndProductPrintByItem;
