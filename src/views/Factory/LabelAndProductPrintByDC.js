...
const LabelAndProductPrintByDC = () => {
    ...
    return (
        <div className="123">
            ...
            <CRow style={{ marginTop: "3%" }}>
                <CCol md="12">
                    <h1 id="ccmaster" style={{ textAlign: "center" }}>Print label & Product Stickers By DC Number / QR Code</h1>
                </CCol>
            </CRow>
            ...
            <CRow style={{ marginTop: "3%" }}>
                ...
                <CCol md="6">
                    <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        ...
                        <CCardBody>
                            <CFormGroup>
                                <CLabel htmlFor="">DC Number <span style={{ color: "red" }}>*</span></CLabel>
                                <CInput
                                    type="text"
                                    id="OrderNumber"
                                    name="category"
                                    value={OrderNumber}
                                    placeholder="Enter DC Number / Scan QR"
                                    onChange={(event) => {
                                        setOrderNumber(event.target.value);
                                        var obj = {
                                            OrderNumber: event.target.value
                                        }
                                        axios.post(MyApiUrl + "OrderDetailsByDCNumber", obj).then((response) => {
...
export default LabelAndProductPrintByDC;
