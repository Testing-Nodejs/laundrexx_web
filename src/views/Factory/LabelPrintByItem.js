        ...
        <div className="123">
            ...
            <CRow style={{ marginTop: "3%" }}>
                <CCol md="12">
                    ...
                    <h1 id="ccmaster" style={{ textAlign: "center" }}>Print label Stickers By Item Number / QR Code</h1>
                </CCol>
            </CRow>
            <CRow style={{ marginTop: "3%" }}>
                <CCol md="3"></CCol>
                            ...
                            <CFormGroup>
                                ...
                                <CInput
                                    ...
                                    onChange={(event) => {
                                        ...
                                        let MyVal = event.target.value.split("-");
                                        var obj = {
                                            OrderNumber: MyVal[0] + "-" + MyVal[1] + "-" + MyVal[2]
                                        }
                                        console.log(obj)
...
export default LabelPrintByItem;
