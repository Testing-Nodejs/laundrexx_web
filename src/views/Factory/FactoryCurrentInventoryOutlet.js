...
const CurrentInventoryOutlet = () => {
            ...
            if (response.data.length > 0) {
                const items = response.data.map((item, index) => {
                    return {
                        ...
                        "Item Number": item.ORDER_ITEM_NUMBER,
                        "Item Name": item.ITEMS_NAME,
                        "Additional Service Name": item.ADDITIONAL_SERVICE_NAME === "" || item.ADDITIONAL_SERVICE_NAME === null ? "None" : item.ADDITIONAL_SERVICE_NAME,
                        "Item Defect": item.ORDER_ITEM_DEFECT,
                        "Customer Name ": item.CUSTOMER_NAME,
                        "Customer Type": item.CUSTOMER_TYPE_NAME,
                        "Outlet Code": item.STORE_CODE,
    ...
    return (
        <div id="city">
            ...
            <h1 id="ccmaster">Outlet Current Inventory</h1>
                                ...
                                {ResponseData.map((item, index) => {
                                    return (
                                        <tr>
                                            ...
                                            <td style={{ textAlign: "center" }}>{item.ADDITIONAL_SERVICE_NAME == "" || item.ADDITIONAL_SERVICE_NAME == null ? "None" : item.ADDITIONAL_SERVICE_NAME}</td>
            ...
            <CRow>
                <CCol col="12">
                    <CCard>
                        <CCardHeader>
                            <div style={{ float: 'left' }}>View Outlet Current Inventory</div>
...
export default CurrentInventoryOutlet;
