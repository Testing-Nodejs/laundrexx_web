...
const ViewOutletReceivedItems = () => {
    ...
    const getAllOrders = () => {
        ...
        axios.get(MyApiUrl + "ViewConfirmedOutletIntake/" + FactoryID + "").then((response) => {
            const items = response.data.map((item, index) => {
                return {
                    ...item,
                    "Sl No.": index + 1,
                    "DC Number": item.FACTORY_DC_NUMBER,
                    "Order Date": SplitDate1(item.FACTORY_DC_DATE),
    ...
    const filterData = (outlet, month, year) => {
        ...
        console.log(object);
        document.getElementById("divLoading").className = "show";
        axios.post(MyApiUrl + "ViewConfirmedOutletIntakeFilter", object).then((response) => {
    ...
    const printModalInvoice = async (id) => {
        ...
        await axios.post(MyApiUrl + "ViewConfirmedOutletIntakeByDCNumber", obj).then(async (response) => {
    ...
    return (
        ...
        <div id="city">
            ...
            <h1 id="ccmaster" style={{marginTop: "3%"}}>View Confirmed Outlet DC</h1>
                        ...
                        <center>
                            <table width="525" className="bottom" cellspacing="0" cellpadding="2" style={{ borderLeft: "1px solid #000", borderTop: "1px solid #000", }}>
                                ...
                                <tr style={{
                                    ...
                                    <td>: &nbsp;&nbsp;&nbsp;{ModalPrintDCData[0].STORE_NAME}</td>
                                    <td style={{ fontWeight: "300" }}>To Station</td>
                                    <td style={{ borderRight: "1px solid #000" }}>: &nbsp;&nbsp;&nbsp;{FactoryName}</td>
                                </tr>
                                <tr style={{
                                    fontWeight: "600",
                                    fontSize: "9px"
                            ...
                            <table width="525" border="0" cellspacing="0" cellpadding="2" style={{ borderTop: "1px solid #000", fontSize: 10 }}>
                                ...
                                <tr>
                                    ...
                                    <td style={{
                                        ...
                                        borderBottom: "1px solid #000",
                                        borderRight: "1px solid #000"
                                    }}><b style={{ fontWeight: "800" }} >Total Orders: {ModalPrintDCData[0].DCInnerItems.length}</b></td>
                                    <td style={{
                                        textAlign: "center",
                                        borderBottom: "1px solid #000",
                                        borderRight: "1px solid #000"
                                    }}><b style={{ fontWeight: "800" }} >Total Quantity: {ModalPrintDCData[0].TotalQuantity}</b></td>
                                </tr>
                                <tr>
                                    <td colSpan="4" style={{
                                        textAlign: "center",
                        ...
                        <center>
                            <table width="525" className="bottom" cellspacing="0" cellpadding="2" style={{ borderLeft: "1px solid #000", borderTop: "1px solid #000", }}>
                                ...
                                <tr style={{
                                    ...
                                    <td style={{ fontWeight: "300" }} width="15%">Date</td>
                                    <td style={{ borderRight: "1px solid #000" }} width="35%">
                                        : &nbsp;&nbsp;&nbsp;<b>{SplitDate1(PrintDCData[0].FACTORY_DC_DATE)}</b>
                                    </td>
                                </tr>
                                <tr style={{
                                    borderRight: "thin solid",
                                    ...
                                    <td style={{ fontWeight: "300" }}>From Station</td>
                                    <td>: &nbsp;&nbsp;&nbsp;{PrintDCData[0].STORE_NAME}</td>
                                    <td style={{ fontWeight: "300" }}>To Station</td>
                                    <td style={{ borderRight: "1px solid #000" }}>: &nbsp;&nbsp;&nbsp;{FactoryName}</td>
                                </tr>
                                <tr style={{
                            ...
                            <table width="525" border="0" cellspacing="0" cellpadding="2" style={{ borderTop: "1px solid #000", fontSize: 10 }}>
                                ...
                                <tr>
                                    ...
                                    <td style={{
                                        ...
                                        borderBottom: "1px solid #000",
                                        borderRight: "1px solid #000"
                                    }}><b style={{ fontWeight: "800" }} >Total Orders: {PrintDCData[0].DCInnerItems.length}</b></td>
                                    <td style={{
                                        textAlign: "center",
                                        borderBottom: "1px solid #000",
                                        borderRight: "1px solid #000"
                                    }}><b style={{ fontWeight: "800" }} >Total Quantity: {PrintDCData[0].TotalQuantity}</b></td>
                                </tr>
                                <tr>
                                    <td colSpan="4" style={{
                                        textAlign: "center",
            ...
            <CRow>
                <CCol col="12">
                    <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        <CCardHeader>
                            <div style={{ float: "left" }}>View All Confirmed Outlet DC</div>
...
export default ViewOutletReceivedItems;
