        ...
        <div className="123">
            ...
            <CRow style={{ marginTop: "3%" }}>
                <CCol md="12">
                    ...
                    <h1 id="ccmaster" style={{ textAlign: "center" }}>Print Product Stickers By Item Number / QR Code</h1>
                </CCol>
            </CRow>
            <CRow style={{ marginTop: "3%" }}>
                <CCol md="3"></CCol>
                <CCol md="6">
                    <CCard style={{ boxShadow: "0px 0px 1px 1px #959595" }}>
                        ...
                        <CCardBody>
                            <CFormGroup>
                                <CLabel htmlFor="">Item Number <span style={{ color: "red" }}>*</span></CLabel>
                                <CInput
                                    type="text"
                                    id="OrderNumber"
                                    name="category"
                                    value={OrderNumber}
                                    placeholder="Enter Item Number / Scan QR"
                                    onChange={(event) => {
                                        setOrderNumber(event.target.value);
                                        var obj = {
                                            ItemNumber: event.target.value
                                        }
                                        axios.post(MyApiUrl + "ItemDetailsByItemNumber", obj).then((response) => {
                                ...
                                <table style={{ height: "80px", width: "100%", borderBottom: "3px solid rgb(0, 0, 0)", borderTop: "3px solid black" }} cellpadding="4" cellspacing="2" class="tbl">
                                    <tr>
                                        <td style={{ border: "0px", width: "30%" }}>
                                            <img class="barcode" alt="barcode" style={{ width: "85px", height: "85px" }} src={ViewImg + "/" + item.ORDER_ITEM_QR} />
                                        </td>
                                        <td style={{ border: "0px" }}>
                                            <b style={{ fontSize: "20px" }}>{item.CUSTOMER_NAME}</b>
                                        </td>
                                        <td style={{ border: "0px" }}>
                                            <b>SD - {cnt + 1} / {OrderNumberData.length}</b>
                                        </td>
                                    </tr>
                                    <tr style={{ width: "100%" }} align="center" >
                                        <td colspan="2" style={{ paddingLeft: "20px" }}>
                                            <table style={{ width: "140%", borderCollapse: "collapse", padding: "0px" }}>
                                                ...
                                                <td style={{ borderBottom: "1px solid black", fontSize: "16px", textAlign: "center" }} align="center"><b>{item.ORDER_ITEM_NUMBER}</b></td>

                                                <tr>
                                                    <td colspan="3" align="center" style={{ fontSize: "14px", textAlign: "center", paddingLeft: "3em" }}><b>{item.SERVICE_CATEGORY_CODE} - {item.ITEMS_NAME}</b></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
...
export default ProductPrintByItem;
