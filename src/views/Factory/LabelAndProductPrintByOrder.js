...
const LabelAndProductPrintByOrder = () => {
        ...
        <div className="123">
            ...
            <CRow style={{ marginTop: "3%" }}>
                <CCol md="12">
                    ...
                    <h1 id="ccmaster" style={{ textAlign: "center" }}>Print Label & Product Stickers By Order Number / QR Code</h1>
                </CCol>
            </CRow>
            <CRow style={{ marginTop: "3%" }}>
                <CCol md="3"></CCol>
...
export default LabelAndProductPrintByOrder;
