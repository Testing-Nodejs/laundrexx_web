...
const ReceiveItemsFactory = (props) => {
    ...
    const SubmitInventory = () => {
        ...
        axios.get(MyApiUrl + "FactoryConfirmInTakeFromFactory/" + ReceivedData[0].FACTORY_TO_FACTORY_DC_PKID + "").then((response) => {
            ...
            if (response.data === true) {
                ...
                history.push("/ViewFactoryReceivedItems");
                                ...
                                <CRow>
                                    <CCol md="6" style={{ borderRight: "1px solid #e9ecef" }}>
                                        <CFormGroup row>
                                            ...
                                            <CCol md="8">
                                                <span style={{ fontSize: "14px", color: "#757575" }}>{ReceivedData[0].FACTORY_TO_FACTORY_DC_NUMBER}</span>
                                            </CCol>
                                        </CFormGroup>
                                        <CDropdownDivider />
                                        <CFormGroup row>
                                            <CCol md="4">
                                                <span style={{ fontSize: "13px", color: "#3c3c3c" }}>From Factory:</span>
                                            </CCol>
                                            <CCol md="8">
                                        ...
                                        <CFormGroup row>
                                            ...
                                            <CCol md="8">
                                                <span style={{ fontSize: "14px", color: "#757575" }}>{ReceivedData[0].FACTORY_STAFF_NAME}</span>
                                            </CCol>
                                        </CFormGroup>
                                    </CCol>
                                    ...
                                    <CCol md="6">
                                        <CFormGroup row>
                                            ...
                                            <CCol md="8">
                                                <span style={{ fontSize: "14px", color: "#757575" }}>{(ReceivedData[0].FACTORY_TO_FACTORY_DC_DATE).split("T")[0]}</span>
                                            </CCol>
                                        </CFormGroup>
                                        <CDropdownDivider />
                                        <CFormGroup row>
                                            <CCol md="4">
                                                <span style={{ fontSize: "13px", color: "#3c3c3c" }}>To Factory:</span>
                                            </CCol>
                                            <CCol md="8">
                                                <span style={{ fontSize: "14px", color: "#757575" }}>{ReceivedData[0].FACTORY_NAME}</span>
                                            </CCol>
                                        </CFormGroup>
                                    </CCol>
                                </CRow>
                            ...
                            <div style={{ overflow: "auto" }}>
                                ...
                                >
                                    ...
                                    <thead>
                                        {ReceivedData.length > 0 ?
                                            <tr>
                                                <td colSpan="3">Total Bags: {ReceivedData[0].FACTORY_TO_FACTORY_DC_TOTAL_BAGS}</td>
                                                <td colSpan="2">Total Items: {ReceivedData[0].FACTORY_TO_FACTORY_DC_ITEM_COUNT}</td>
                                            </tr> : null
                                        }
                                        <tr>
                                            <th>
...
export default ReceiveItemsFactory;
